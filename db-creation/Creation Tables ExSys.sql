...
CREATE TABLE Instructor (
    ...
    dept_id INT,
    gender NVARCHAR(10) NOT NULL DEFAULT 'M',
...
-------  don't forget to uploud on git
------
ALTER TABLE Exam
ADD CONSTRAINT CHK_Exm_Model CHECK (exm_model IN (1, 2, 3, 4));


---- department 
ALTER TABLE Department
ADD CONSTRAINT FK_Department_Mgr FOREIGN KEY (mgr_id) REFERENCES Instructor(ins_id)
ON DELETE NO ACTION
ON UPDATE NO ACTION;