...
GO;
-- test 
EXEC AddStdCourse 101, 40, '2024-01-01';
...
GO;
-- test
EXEC DeleteStdCourse 101, 40;


--- 3- Select Std_Course
CREATE OR ALTER PROCEDURE SelectStdCourse(@crs_id int, @std_id int)
AS
IF EXISTS (
    SELECT *
    FROM Std_Course
...
GO;
--- test
EXEC DeleteInsCourse 101, 50;


-- 3- Select Ins_Course
CREATE OR ALTER PROCEDURE SelectInsCourse(@crs_id int, @ins_id int)
AS
IF EXISTS (
    SELECT *
    FROM Ins_Course
...
GO;
--- test
EXEC UpdateInsCourse 101, 50, 102, 51;
